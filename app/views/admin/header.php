...
input[type="text"],.cat {border:1px solid #ddd;margin-bottom:5px;padding:5px;width:350px;font-size:16px}
input[type="submit"]{cursor: pointer}

.adminleft{width: 200px;float: left;border-right: 1px solid #ddd; margin-right: 10px; padding-right: 10px; }
.widget{margin-bottom: 20px;}
.widget h3{background:#3399FF none repeat scroll 0 0;border-bottom:2px solid #066cd2; color: #000; margin:0 0 2px; padding: 5px;}
...
.adminright h2{border-bottom: 1px dashed #666; margin: 0 0 10px; padding-bottom: 10px;}
