...
.postcontent{width: 560px; border-right: 1px solid #ddd; float: left;margin-right: 18px;padding-right: 19px;overflow: hidden;}
...
.searchoption{border-bottom: 2px dashed #2299FF; margin-bottom: 15px;padding-bottom: 10px; overflow: hidden;}
...
.search{float: right;}
.catsearch{ border: 1px solid #ddd; font-size: 16px; margin-bottom: 5px; padding-bottom: 10px; overflow: hidden;cursor: pointer;   }
